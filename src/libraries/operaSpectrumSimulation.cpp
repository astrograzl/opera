...
operaFluxVector& SimulatedSpectrum(simulation_t SimulationType, SpectrumVariables_t SpectrumVariables, operaFluxVector& ESPaDOnSBeamIntensity)
{
    switch (SimulationType) {
        case BlackBody: {
            operaStokesVector BlackBodyStokesVector(SpectrumVariables.length);
            operaStokesVector ESPaDOnSBeam(SpectrumVariables.length);
            
            BlackBodyStokesVector.setStokesParameters(GenerateBlackBodyStokesVector(SpectrumVariables.length, SpectrumVariables.ErrorType, SpectrumVariables.ErrorPercentage, SpectrumVariables.Temperature, SpectrumVariables.MinWavelength, SpectrumVariables.MaxWavelength, SpectrumVariables.WavelengthIncrement, SpectrumVariables.StokesParameter, SpectrumVariables.StokesParameterFractionPolarizationOfBlackBody, BlackBodyStokesVector));
            
            ESPaDOnSBeam.setStokesParameters(ESPaDOnSBeamCreator(BlackBodyStokesVector, ESPaDOnSBeam, SpectrumVariables.Rhomb1Angle, SpectrumVariables.Rhomb2Angle, SpectrumVariables.Beam));
            
			ESPaDOnSBeamIntensity.setVector(*ESPaDOnSBeam.getStokesParameter(StokesI));
        }
            break;
        case GalileanMoon: {
            operaStokesVector GalileanMoonStokesVector(SpectrumVariables.length);
            operaStokesVector ESPaDOnSBeam(SpectrumVariables.length);
            
            GalileanMoonStokesVector.setStokesParameters(GenerateGalileanMoonStokesVector(SpectrumVariables.length, SpectrumVariables.ErrorType, SpectrumVariables.ErrorPercentage, SpectrumVariables.MinWavelength, SpectrumVariables.MaxWavelength, SpectrumVariables.WavelengthIncrement, *SpectrumVariables.SunSpectrum, SpectrumVariables.ReflectedJupiterFractionOfSunSpectrum, SpectrumVariables.StokesParameter, SpectrumVariables.NumberOfPolarizationPeaks, SpectrumVariables.AmplitudeOfPolarizationVector, SpectrumVariables.SigmaOfPolarizationVector, SpectrumVariables.CenterOfPolarizationVector, GalileanMoonStokesVector));
            
            ESPaDOnSBeam.setStokesParameters(ESPaDOnSBeamCreator(GalileanMoonStokesVector, ESPaDOnSBeam, SpectrumVariables.Rhomb1Angle, SpectrumVariables.Rhomb2Angle, SpectrumVariables.Beam));
        ...
        case ZeemanLine: {
            ...
            operaStokesVector ZeemanLineStokesVector(SpectrumVariables.length);
            operaStokesVector ESPaDOnSBeam(SpectrumVariables.length);
            
            ZeemanLineStokesVector.setStokesParameters(GenerateZeemanLineStokesVector(SpectrumVariables,ZeemanLineStokesVector));
            
            ESPaDOnSBeam.setStokesParameters(ESPaDOnSBeamCreator(ZeemanLineStokesVector, ESPaDOnSBeam, SpectrumVariables.Rhomb1Angle, SpectrumVariables.Rhomb2Angle, SpectrumVariables.Beam));
...
{    
    ...
    OutputStokesVector.setStokesParameters(WollastonBeam[Beam] * FresnelHalfWaveRhomb2 * FresnelQuaterWaveRhomb * FresnelHalfWaveRhomb1 * InputStokesVector);
