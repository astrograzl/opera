...
int main(int argc, char *argv[])
{
	...
	try {
		...
		if (verbose) {
            ...
            cout << "operaPolarIntensity: flux calibrate = " << fluxcalibrate << endl; 
            cout << "operaPolarIntensity: LE flux calibrate = " << LEFluxCalibrate << endl; 
            cout << "operaPolarIntensity: LE input flux calibration file = " << LEfluxCalibration << endl; 
			cout << "operaPolarIntensity: exposure time = " << exposureTime << endl;
			cout << "operaPolarIntensity: order bin = " << orderBin << endl;
            ...
            cout << "operaPolarIntensity: flatfieldspectrum = " << flatfieldspectrum << endl;
