#ifndef OPERACREATEFLATFIELDFLUXCALIBRATION_H
#define OPERACREATEFLATFIELDFLUXCALIBRATION_H
/*******************************************************************
 ****                  MODULE FOR OPERA v1.0                     ***
 *******************************************************************
 Module name: operaCreateFlatFieldFluxCalibration
 Version: 1.0
 Description: Create a flux calibrated spectrum from a flat field
...
/*! \brief Create a flux calibrated spectrum. */
/*! \file operaCreateFlatFieldFluxCalibration.h */
/*! \ingroup core */
