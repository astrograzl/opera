#ifndef OPERAEXTRACTIONAPERTURECALIBRATION_H
#define OPERAEXTRACTIONAPERTURECALIBRATION_H
/*******************************************************************
 ****                  MODULE FOR OPERA v1.0                    ****
 *******************************************************************
 Module name: operaExtractionApertureCalibration
 Version: 1.0
 Description: Calculate the extraction aperture.  
...
/*! \brief Calculate the extraction aperture. */
/*! \file operaExtractionApertureCalibration.h */
/*! \ingroup core */
